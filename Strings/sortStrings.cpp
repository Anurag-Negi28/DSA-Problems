// Sort Strings
// Given a list of 'n' strings S0,51,52,...
// ....,Sn-1, each consisting
// of digits and spaces, the number of spaces is the same for
// each entry, the goal is to implement a variation of a sort
// command. None of the strings contains consecutive
// spaces. Also, no string starts with a space nor ends with it.
